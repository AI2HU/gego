  ...
  <div>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 md:mb-8">
      <div>
        ...
        <h1 class="text-2xl md:text-3xl font-semibold text-gray-900 mt-1">Models</h1>
        <p class="text-sm text-gray-500 mt-1 max-w-xl">
          Manage LLM providers and models used for prompt execution. Add models from OpenAI,
          Anthropic, Google, Perplexity, or Ollama.
        </p>
      </div>
